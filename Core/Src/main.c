...
uint32_t taskDefaultBuffer[ 1024 ];
...
void PeriphCommonClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInitStruct.PLL3.PLL3N = 158;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED1_GREEN_Pin|LED3_RED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED1_GREEN_Pin LED3_RED_Pin */
  GPIO_InitStruct.Pin = LED1_GREEN_Pin|LED3_RED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
